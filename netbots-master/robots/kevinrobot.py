    ...
    while True:
        ...
        try:
            ...
            botSocket.sendRecvMessage(
                        {'type': 'fireCanonRequest', 'direction': random.int(0,9)/scanSliceWidth, 'distance': random.int(0,9)/scanSliceWidth})
            ...
            botSocket.sendRecvMessage(
                            {'type': 'fireCanonRequest', 'direction': random.randint(0,90), 'distance': random.randint(0,10)})
        except nbipc.NetBotSocketException as e:
